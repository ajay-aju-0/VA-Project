def start():
    ...
    scores=[i for i in range(300,1001,500)]
    ...
    #background image
    bgimg=pygame.image.load("Games/Snake/snake images/bgimg.jpg")
    bgimg=pygame.transform.scale(bgimg,(screen_width,screen_height)).convert_alpha()

    #welcome screen image
    wcbg = pygame.image.load("Games/Snake/snake images/wlcm.jpeg")
    wcbg = pygame.transform.scale(wcbg, (screen_width, screen_height)).convert_alpha()

    #game over screen image
    ovbg = pygame.image.load("Games/Snake/snake images/gmov.jpg")
    ...
    def drawGrids():
        for x in range(0,screen_width,cell):
            for y in range(0,screen_height,cell):
                ...
                pygame.draw.rect(gameWindow,'#404040',rect,1,8)



    def playmusic():
        pygame.mixer.music.fadeout(200)
        pygame.mixer.music.load("Games/Snake/snake sounds/background.mp3")
    ...
    def gameLoop():
        ...
        snake_size = 30
        score = 0
        food_x = (random.randint(0, screen_width)//cell)*cell
        food_y = (random.randint(0, screen_height)//cell)*cell
        fps = 10
        initVelocity = 30
        snake_length = 1
        snk_list = []
        ...
        while not exit_game:
            if over_game:
                ...
                if abs(snake_x-food_x)<10 and abs(snake_y-food_y)<10:
                    beep=pygame.mixer.Sound("Games/Snake/snake sounds/beep.wav")
                ...
                pygame.draw.rect(gameWindow, yellow, [food_x, food_y, cell, cell])
                head=[]
                head.append(snake_x)
                head.append(snake_y)
                ...
                if head in snk_list[:-1]:
                    pygame.mixer.music.load("Games/Snake/snake sounds/explosion.mp3")
